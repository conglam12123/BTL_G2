...
/*--______T?O RÀNG BU?C FOREGIN KEY______--*/
...
INSERT INTO tbl_nguyen_lieu(ten, so_luong, don_gia, don_vi) VALUES ('M?c', '500', '150000', 'kg'),
								   ('Tr?ng', '100', '3000', 'qu?'),
								   ('Th?t', '250', '80000', 'kg');

INSERT INTO tbl_nguyen_lieu(ten, so_luong, don_gia, don_vi) VALUES ('Cá', '500', '250000', 'kg');


--T?o procedure l?y ra tài kho?n, m?t kh?u
...
AS
	...
	END
GO
	EXECUTE get_login 'dotuyen221098@gmail.com','1';

--T?o procedure l?y ra danh sách nguyên li?u
...
--T?o procedure l?y ra danh sách nguyên li?u
ALTER PROCEDURE get_dsnguyenlieu
AS
	BEGIN
...
--T?o procedure thêm nguyên li?u
ALTER PROCEDURE insert_nguyenlieu
	@ten nvarchar(100),
	@soluong int,
	@dongia int,
	@donvi varchar(50)
...
--T?o procedure update nguyên li?u
ALTER PROCEDURE update_nguyenlieu
	@ma INT,
	@ten nvarchar(100),
	@soluong int,
	@dongia int,
